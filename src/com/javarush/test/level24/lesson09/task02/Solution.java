...
public class Solution {
    ...
    public static void printStocks(List<Stock> stocks, Date actualDate) {
        ...
        Format[] testFormats = {null, null, SimpleDateFormat.getDateTimeInstance(0,0, ru), fileform};
    ...
    public static void sort(List<Stock> list) {
        Collections.sort(list, new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                Date dateToComp1 = new Date(((Date) stock1.get("date")).getTime());
                Date dateToComp2 = new Date(((Date) stock2.get("date")).getTime());
                dateToComp1.setHours(0);
                dateToComp1.setMinutes(0);
                dateToComp1.setSeconds(0);
                dateToComp2.setHours(0);
                dateToComp2.setMinutes(0);
                dateToComp2.setSeconds(0);
                result = dateToComp2.compareTo(dateToComp1);
                if (result != 0) {
                    return result;
                }
                Double toComp1;
                ...
                if (stock1.containsKey("change")) {
                     toComp1 = (Double) stock1.get("change");
                } else {
