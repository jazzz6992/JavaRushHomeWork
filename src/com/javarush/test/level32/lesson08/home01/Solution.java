...
public class Solution {
    ...
    public static SomeInterfaceWithMethods getProxy() {
        SomeInterfaceWithMethods someInt = new SomeInterfaceWithMethodsImpl();
        ClassLoader classLoader = someInt.getClass().getClassLoader();
        Class<?>[] interfaces = someInt.getClass().getInterfaces();
        CustomInvocationHandler ih = new CustomInvocationHandler(someInt);
        SomeInterfaceWithMethods prox = (SomeInterfaceWithMethods) Proxy.newProxyInstance(classLoader, interfaces, ih);
        return prox;
    }
}
